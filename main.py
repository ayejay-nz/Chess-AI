...
def main():
    ...
    capturing_moves, castling_moves, pawn_moves = find_legal_moves(white_bbs, black_bbs, gamestate.is_whites_move, gamestate.castling_rights)
    all_moves = capturing_moves + castling_moves + pawn_moves
